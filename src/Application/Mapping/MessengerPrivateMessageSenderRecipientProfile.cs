...
{
    public class MessengerPrivateMessageSenderRecipientProfile : Profile
    {
        public MessengerPrivateMessageSenderRecipientProfile()
        {
            //CreateMap<MessengerPrivateMessage, MessengerDisplayPrivateMessageSenderRecipientDto>()
