    ...
    public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        public ApiExceptionFilterAttribute()
        {
            ...
            _exceptionHandlers = new Dictionary<Type, Action<ExceptionContext>>
            {
                ...
                { typeof(Exception),HandleCustomException }
            };
        }
        ...
        private void HandleBadRequestException(ExceptionContext context)
        {
            ...
            {
                Type = "https://tools.ietf.org/html/rfc7231#section-6.5.1",
                Detail = exception?.CustomMessage,
            };
        ...
        private void HandleDbException(ExceptionContext context)
        {
            var details = new ProblemDetails
            {
                ...
                Detail = "امکان ذخیره‌سازی اطلاعات وجود ندارد؛ دوباره تلاش نمائید",
            };
        ...
        private void HandleDBConcurrencyException(ExceptionContext context)
        {
            var details = new ProblemDetails
            {
                ...
                Title = "An error occurred while processing your request.",
                Type = "https://tools.ietf.org/html/rfc7231#section-6.6.1",
                Detail = "اطلاعات توسط کاربری دیگر در شبکه تغییر کرده است",
            };
        ...
        public void HandleAggregateException(ExceptionContext context)
        {
            ...
            var details = new ProblemDetails
            {
                ...
                Title = "An error occurred while processing your request.",
                Type = "https://tools.ietf.org/html/rfc7231#section-6.6.1",
                Detail = JsonConvert.SerializeObject(exceptions.InnerExceptions.Select(c => c.Message)),
            };
        ...
        {
            var exceptions = context.Exception as Exception;
            var details = new ProblemDetails
            {
                Status = StatusCodes.Status500InternalServerError,
                Title = "An error occurred while processing your request.",
                Type = "https://tools.ietf.org/html/rfc7231#section-6.6.1",
                Detail = exceptions.Message
            };
